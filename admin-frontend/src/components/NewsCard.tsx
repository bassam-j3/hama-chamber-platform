      ...
      <div className="position-relative overflow-hidden" style={{ height: "240px" }}>
        {item.imageUrl ? (
          ...
          <div className="w-100 h-100 bg-light d-flex align-items-center justify-content-center text-muted">
             <span className="material-symbols-outlined fs-1">image</span>
          </div>
        )}
        <Badge bg="primary" className="position-absolute top-0 end-0 m-3 px-3 py-2 rounded-2 shadow bg-opacity-90 fw-normal">
          أخبار الغرفة
        </Badge>
      </div>
