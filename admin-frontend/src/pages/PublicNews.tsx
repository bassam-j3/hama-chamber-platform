    ...
    <div className="py-4 py-md-5" style={{ backgroundColor: '#f9fafc', minHeight: '100vh' }} dir="rtl">
      <Container>
        <div className="mb-4 mb-md-5 text-center position-relative">
          ...
          <h1 className="fw-bold text-primary mb-2 mb-md-3 h2 h1-md">كل الأخبار والتقارير</h1>
          <p className="text-secondary fs-6 fs-md-5 px-3">تابع أحدث الأخبار والفعاليات في غرفة تجارة حماة</p>
        </div>
             ...
             {[...Array(6)].map((_, idx) => (
                <Col lg={4} md={6} key={idx}>
                  <div className="card h-100 border-0 rounded-4 shadow-sm">
                    <Placeholder as="div" animation="glow" style={{ height: "200px" }} className="w-100 bg-light rounded-top" />
